    ...
    return (
        <section id={id} className="relative overflow-hidden p-[clamp(2rem,5vw,4.5rem)_0] bg-gradient-to-b from-[--a]/10 to-[--c]/10">
            ...
            <div className="w-[min(1200px,92vw)] mx-auto">
                ...
                <h3 className="sub-heading reveal">Core System Layers</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[clamp(1rem,2.5vw,2rem)]">
                    <Card title="Sync Protocol">UDP multicast keeps all nodes aligned to the same millisecond grid.</Card>
                    <Card title="Effect Engine">Real-time rendering of visual and kinetic effects with power-budget control.</Card>
                    <Card title="Web Control">Self-hosted panel for configuration, diagnostics, and live sequencing.</Card>
                </div>
            </div>
        </section>
    );
