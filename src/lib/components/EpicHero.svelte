<script>
  ...
  export let variant = 'default'; // 'default' | 'product' | 'case'
</script>

<section id="hero" class="section container" style="padding-top:clamp(2rem,10vh,8rem)">
  <div class="reveal" data-halo="3" style="padding:clamp(1rem,3vw,1.5rem)">
    ...
    <div class="glassbar">
      <a href="#examples" class="btn primary">See examples</a>
